...
class countDown {
    ...
    refreshTime(isStart) {
        ...
        if (this.countType == "date") {
            const day = this.ten(Math.floor(this.timePassed / (60 * 60 * 24)));
            const hour = this.ten(Math.floor(this.timePassed / (60 * 60)) - day * 24);
            const minute = this.ten(Math.floor(this.timePassed / 60) - (day * 24 * 60) - (hour * 60));
            const second = this.ten(Math.floor(this.timePassed) - (day * 24 * 60 * 60) - (hour * 60 * 60) - (minute * 60));
...
export default o => new countDown(o);
